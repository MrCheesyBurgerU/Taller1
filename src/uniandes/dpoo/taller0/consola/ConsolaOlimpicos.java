...
public class ConsolaOlimpicos
{
	...
	public void mostrarMenu()
	{
		...
		System.out.println("13. Consultar el páis de un atleta");
	...
	/**
	 * Ejecuta la opción para consultar el país en función de un nombre de atleta ingresado.
	 * Método agregado para suplir módificación 1
	 */
	private void ejecutarPaisAtleta()
	{
		String nombre = input("Por favor ingrese el nombre del atleta a consultar: ");
		
		Pais paisbusc = calculadora.darPaisAtleta(nombre);
		
		if (paisbusc != null)
		{
		System.out.println("El pais de origen del atleta ingresado es "+paisbusc.darNombre());
		}
		else
		{
		System.out.println("El nombre ingresado no es válido. Intentelo nuevamente");
		}
	}
