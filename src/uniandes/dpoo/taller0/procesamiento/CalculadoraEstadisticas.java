...
public class CalculadoraEstadisticas
{
	...
	/**
	 * Retorna el pais del cual es originario el atleta
	 * 
	 * @param nombreAtleta El nombre del atleta que se está buscando
	 * @return El pais del atleta con el nombre dado o null si no lo encuentra.
	 * Método agregado para suplir modificación 1
	 */
	public Pais darPaisAtleta(String nombreAtleta)
	{	
		Atleta atletabusc = buscarAtleta(nombreAtleta);
		Pais paisatleta = null;
		
		if (atletabusc != null) 
		{
			paisatleta = atletabusc.darPais();
		}
